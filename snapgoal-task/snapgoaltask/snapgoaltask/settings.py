"""
Django settings for snapgoaltask project.
...
ROOT_URLCONF = "snapgoaltask.urls"
...
WSGI_APPLICATION = "snapgoaltask.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Documentation of api's snapgoal task",
