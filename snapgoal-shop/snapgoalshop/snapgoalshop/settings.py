"""
Django settings for snapgoalshop project.
...
ROOT_URLCONF = "snapgoalshop.urls"
...
WSGI_APPLICATION = "snapgoalshop.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Documentation of api's snapgoal shop",
